...
def generate_launch_description():
    ...
    robot_description_content = Command(
        [
            ...
            PathJoinSubstitution(
                [FindPackageShare("three_wheeled_omni_robot_description"), "urdf/robot", "omni_robot.urdf.xacro"]
            ),
            " ",
            "sim_mode:=",
            use_sim_time,
    ...
    robot_controllers = PathJoinSubstitution(
        [
            FindPackageShare("omnidrive_arduino"),
            "config",
            "controllers.yaml",
        ]
    )
    rviz_config_file = PathJoinSubstitution(
        [FindPackageShare("three_wheeled_omni_robot_description"), "config", "default.rviz"]
    )
